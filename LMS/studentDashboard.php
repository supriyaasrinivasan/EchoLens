...
<head>
    ...
    <title>Syraa Lambda - Student Dashboard</title>
    ...
    <div class="content">
        ...
        <div class="container-fluid mt-4">
            <div class="welcome-section">
                <h1>Welcome, <span><?php echo isset($_SESSION['user']['name']) ? $_SESSION['user']['name'] : 'Guest'; ?></span></h1>
                <p>Here's an overview of your courses and learning progress.</p>
            </div>
            <div class="row g-4" id="semester-cards-container">
        ...
        <div class="col-md-3">
            <div class="card shadow-lg">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-end">
                        <h2 class="fw-bold mb-3">Semester ${i}</h2>
                        <p class="text-description mt-1">Semester Courses</p>
                    </div>
                </div>
            </div>
        </div>
